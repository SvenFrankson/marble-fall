...
class SpacePanel extends HTMLElement {
    constructor() {
        ...
        this._update = () => {
            ...
            let dView = this._target.position.subtract(this.game.camera.position);
            ...
            let screenPos = BABYLON.Vector3.Project(p2, BABYLON.Matrix.Identity(), this._target.getScene().getTransformMatrix(), this.game.camera.viewport.toGlobal(1, 1));
